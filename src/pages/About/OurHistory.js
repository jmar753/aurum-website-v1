    ...
    return(
      	...
      	<div className="flex flex-col justify-center items-center text-gray-100 bg-aurumblack">
			<div  className="h-auto w-full max-w-7xl px-8 pt-36">
				...
				<div className="space-y-8 py-12 grid grid-cols-2" propDelay={0.1}>
				...
				<div className="space-y-8 py-12 bg-aurumaqua-background rounded-3xl" propDelay={0.1}>
				...
				<div className="py-12 grid grid-cols-2" propDelay={0.1}>
					<p className="text-2xl">“What is your greatest success?”</p>
					<p className="text-xl">It’s hard to narrow down my greatest success. The thing is when you do things, to me it didn’t sound like a big deal. It was a big deal for someone who didn’t know anything about it. I was one of the few leaders in the industry while being honest.</p>
				</div>

				<div className="py-12 grid grid-cols-2" propDelay={0.1}>
					<p className="text-2xl">“What’s one of the most challenging obstacles you went through?”</p>
					<p className="text-xl">Probably the most annoying thing was sitting down with a patent lawyer. Every little thing that would take up a quarter of a page they wrote 20 pages for. I would be still reading today if I read it all.</p>
				</div>
				...
				<div className="space-y-8 py-12 flex flex-col items-center justify-center" propDelay={0.1}>
					<img src="https://www.aurum-m.ca/wp-content/themes/twentyseventeen-child/assets/images/Adam_and_Stacy.png"></img>
					<p>Founders Adam (Right) and Stacy Zorzit (Middle) with their brother Richard Zorzit (Left), 2017</p>
				</div>

				<div className="space-y-8 py-12" propDelay={0.1}>
					<p className="text-xl">Adam and Stacy are determined to lead Aurum and the entire HVAC industry with the same drive, purpose and honesty as their father led before them. The name Aurum was not randomly selected. With the knowledge from their father, there was one family member whose encouragement and support could not go without recognition. Therefore, they believed to properly show their appreciation and love for their mother Ornella, they decided to name the company after her. </p>
				</div>

				<div className="space-y-8 py-12 bg-aurumaqua-secondary rounded-3xl" propDelay={0.1}>
					<h1>Ornella</h1>
