    ...
    return(
		<>
			...
			<div className="flex flex-col justify-center items-center text-gray-200 bg-aurumblack">
				...
				<div className="space-y-8 py-6 bg-leafgreen rounded-3xl" >
				...
				{/* Patents */}
				<div>
					<h1 className="pt-24 pb-32 text-3xl text-center">Vittorio's officially patented designs </h1>
				</div>
				...
				<div className="py-6 grid grid-cols-2" >
					...
					<p className="text-base lg:text-xl">It’s hard to narrow down my greatest success. The thing is when you do things, to me it didn’t sound like a big deal. It was a big deal for someone who didn’t know anything about it. I was one of the few leaders in the industry while being honest.</p>
				</div>

				<div className="py-6 grid grid-cols-2" >
					<p className="text-2xl">“What’s one of the most challenging obstacles you went through?”</p>
					<p className="text-base lg:text-xl">Probably the most annoying thing was sitting down with a patent lawyer. Every little thing that would take up a quarter of a page they wrote 20 pages for. I would be still reading today if I read it all.</p>
				</div>
				...
				<div className="space-y-8 py-6 bg-aurumaqua-secondary rounded-3xl" >
					<h1>Ornella</h1>
