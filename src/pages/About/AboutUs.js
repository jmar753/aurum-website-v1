    ...
    return(
        <div className="text-neutral-100 px-6 leading-loose">
            ...
            <div className="bg-gradient-to-b h-56 pt-20 text-5xl font-bold from-aurumblack to-aurumgrey flex items-center justify-center">
                <h1 className="text-neutral-100">About <span className="text-apple-600">Us</span></h1>
            </div>
            ...
            <div className="text-center space-y-8 pb-20">
                ...
                <h1 className="text-3xl font-semibold ">Who <span className="text-apple-600">We Are</span></h1>
                ...
                <h1 className="text-3xl font-semibold ">What <span className="text-apple-600">We Do</span></h1>
