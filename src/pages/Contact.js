        ...
        <div className="h-screen w-full flex items-center justify-center text-gray-800">
            <div className="w-screen pt-16">
                ...
                <div className="text-center space-y-5 py-10">
                    <h1 className="text-5xl ">Contact our team</h1>
                        ...
                        <form className="max-w-3xl mx-auto">
                            <div className="grid lg:grid-cols-2 lg:gap-6">
                                <div className="relative z-0 w-full mb-5 group">
                                    <label for="small-input" className="block mb-2  text-gray-800">First Name</label>
                                ...
                                <div className="relative z-0 w-full mb-5 group">
                                    <label for="small-input" className="block mb-2  text-gray-800">Last Name</label>
                                    <input type="text" id="small-input" className="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-aurumgreen-500 focus:border-aurumgreen-500"/>
                                </div>
                            </div>
                            <div className="relative z-0 w-full mb-5 group">
                                <label for="small-input" className="block mb-2  text-gray-800">Email</label>
                                <input type="text" id="small-input" className="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-aurumgreen-500 focus:border-aurumgreen-500"/>
                            </div>
                            <div className="relative z-0 w-full mb-5 group">
                                <label for="small-input" className="block mb-2  text-gray-800">Phone</label>
                                <input type="text" id="small-input" className="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-aurumgreen-500 focus:border-aurumgreen-500"/>
                            </div>
                            <div className="relative z-0 w-full mb-5 group">
                                <label for="small-input" className="block mb-2  text-gray-800">Message</label>
